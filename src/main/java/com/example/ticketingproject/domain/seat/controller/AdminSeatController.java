...
public class AdminSeatController {
    ...
    public ResponseEntity<CommonResponse<SeatResponse>> create(@PathVariable(name = "venueId") Long venueId, CreateSeatRequest request) {
        return ResponseEntity.status(HttpStatus.CREATED).body(CommonResponse.success(CREATE_SEAT_SUCCESS, CREATE_SEAT_SUCCESS.getSuccessCode(), CREATE_SEAT_SUCCESS.getMessage(), adminSeatService.save(venueId, request)));
    }
}
